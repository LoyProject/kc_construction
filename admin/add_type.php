...
<div class="md:col-span-1">
    ...
    <form action="process_add_type" method="POST" class="space-y-4">        
        <div>
        ...
        <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200">
            ...
            <button type="submit" name="submit_add_type" class="bg-brand-green hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md shadow-sm">Add type</button>
        </div>
    </form>
</div>
