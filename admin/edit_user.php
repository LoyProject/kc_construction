...
<div class="md:col-span-1">
    ...
    <form action="process_edit_user?id=<?php echo urlencode($user_id); ?>" method="POST" class="space-y-4">
        <input type="hidden" name="user_id" value="<?php echo sanitize_output($user['id']); ?>">
        ...
        <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200">
            ...
            <button type="submit" name="submit_edit_user" class="bg-brand-green hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md shadow-sm">Save Changes</button>
        </div>
    </form>
</div>
