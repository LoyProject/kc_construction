...
<div class="md:col-span-1">
    <h2 class="text-xl font-bold mb-4">Add New Style</h2>

    <form action="process_add_style" method="POST" class="space-y-4">        
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700">Style Name <span class="text-red-500">*</span></label>
        ...
        <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200">
            ...
            <button type="submit" name="submit_add_style" class="bg-brand-green hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md shadow-sm">Add Style</button>
        </div>
    </form>
</div>
