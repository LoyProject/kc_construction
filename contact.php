            ...
            <div class="lg:w-2/3">
                ...
                <form class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="text" placeholder="Name*" data-translate="name" class="w-full p-3 bg-brand-gray border border-gray-300 hover:border-2 hover:border-brand-gold"
                            required />
                        <input type="text" placeholder="Phone*" data-translate="phone" class="w-full p-3 bg-brand-gray border border-gray-300 hover:border-2 hover:border-brand-gold" />
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="email" placeholder="Your Email*" data-translate="email" class="w-full p-3 bg-brand-gray border border-gray-300 hover:border-2 hover:border-brand-gold"
                            required />
                        <input type="text" placeholder="Subject*" data-translate="subject" class="w-full p-3 bg-brand-gray border border-gray-300 hover:border-2 hover:border-brand-gold" />
                    </div>

                    <textarea placeholder="Message*" data-translate="message" rows="6" class="w-full p-3 bg-brand-gray border border-gray-300 hover:border-2 hover:border-brand-gold"
                        required></textarea>
                ...
                <div class="bg-brand-gray p-6 shadow-sm">
                    ...
                    <ul class="space-y-3 text-sm">
                        <li class="flex items-center">
                            ...
                            <span id="contact-address" class="overflow-hidden text-ellipsis whitespace-nowrap"></span>
                        </li>
                        <li class="flex items-center">
                            <span class="flex items-center justify-center w-8 h-8 p-1 bg-gray-900 text-brand-gold mr-2">
                                <i class="fa-solid fa-phone-volume"></i>
                            </span>
                            <span data-translate="contact-phone"></span>
                        ...
                        <li class="flex items-center">
                            ...
                            <span data-translate="contact-email"></span>
