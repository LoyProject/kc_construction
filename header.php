...
<head>
    ...
    <!-- Google Fonts: Hanuman for Khmer -->
...
<body class="bg-brand-black text-brand-white w-full min-h-screen overflow-x-hidden">
    <header x-data="{ open: false}"
        class="w-full px-4 sm:px-20 py-4 flex items-center justify-between bg-brand-gray text-brand-gold text-xl shadow-sm mx-auto sticky top-0 z-50 shadow-lg">
            ...
            <div x-cloak x-show="open" class="fixed inset-0 z-40 bg-black/40 flex md:hidden" @click.away="open = false">
                <div class="bg-brand-black text-brand-gold w-3/4 max-w-xs h-full p-6 flex flex-col">
                    ...
                    <ul class="space-y-2 text-sm mt-4">
                        ...
                        <div id="langToggleBtnMobile"
                            class="flex items-center bg-brand-gray p-2 mb-2 hover:bg-brand-gold hover:text-white cursor-pointer">
