                            ...
                            <main class="p-4 sm:p-6 md:p-12">
                                <div class="flex flex-col lg:flex-row gap-8 lg:gap-10">
                                    ...
                                    <div class="w-full lg:w-2/3">
                                        <img src="admin/${project.image_path}" class="shadow mb-4 w-full max-h-[400px] object-cover rounded" />
                                ...
                                <div class="mt-8 sm:mt-10">
                                    <h1 class="text-md sm:text-xl font-semibold text-base lg:text-2xl text-brand-gold">${project.name}</h1>
                                </div>
                                        ...
                                        <table class="min-w-full border border-brand-gray text-sm">
                                            <tbody class="divide-y divide-brand-gray">
                                                <tr class="border border-brand-gray">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.view || 0}</td>
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.investor || ''}</td>
                                                </tr>
                                                <tr class="border-b border-brand-gray">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.style.name || ''}</td>
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.area.name || ''}</td>
                                                </tr>
                                                <tr class="border-b border-brand-gray">
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.floor.name || ''}</td>
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.implement_unit || ''}</td>
                                                </tr>
                                                <tr class="border-b border-brand-gray">
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.implement_at || ''}</td>
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                            <i class="fas fa-bullseye text-brand-gold"></i>
                                                        </span>
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.facade.name || ''}</td>
                                                </tr>
                                                <tr>
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.type.name || ''}</td>
                                                    <td class="flex items-center gap-2 p-3 min-w-[120px]">
                                                        <span class="flex items-center justify-center w-4 h-4 p-1 text-brand-gold mr-2">
                                                    ...
                                                    <td class="p-3 min-w-[100px] border border-brand-gray">${project.size.name || ''}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
