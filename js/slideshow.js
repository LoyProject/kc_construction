    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(slides, function (i, img) {
              ...
              <img src="admin/${img.image_path}" class="absolute block w-full object-cover object-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="" style="max-width:1680px;">
            </div>`
                );
                $indicators.append(
