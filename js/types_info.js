        ...
        success: function(data) {
            ...
            if (data.success) {
                ...
                $.each(data.types, function(index, type) {
                    if (index === 0) {
                        $typesList.append('<div class="type-item hover:text-brand-gold cursor-pointer text-sm sm:text-base lg:text-lg font-semibold text-brand-gold" data-type="all" data-translate="load-all">All</div><span class="mx-6">|</span>');
                    }
                    $typesList.append(`
