          ...
          <div class="product-info p-4">
            ...
            <ul  class="mt-2 text-sm text-brand-white">
                ...
                <li class="flex items-center gap-2 mt-1">
                  ...
                  <strong>Number of floors:</strong> ${product.floors || 'N/A'}
                </li>
            </ul>
          </div>
        </div>
